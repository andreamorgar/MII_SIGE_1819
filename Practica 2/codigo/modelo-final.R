...
# separaTrainTest("./petfinder-adoption-data-prueba/train_images", "./petfinder-adoption-data-prueba/my_test")
separaTrainTest("./petfinder-adoption-data-prueba/train_images", "./petfinder-adoption-data-prueba/validation_images", porcentaje=0.15)
# ---------------------------------------------------------------------------------------------------------
...
# https://tensorflow.rstudio.com/keras/reference/application_vgg.html para vgg16
...
model %>% compile(optimizer = optimizer_adam(), loss = 'categorical_crossentropy', metrics = c("accuracy","mse","categorical_accuracy"))
...
model %>% save_model_hdf5("./filtros_con_imagenet-modelo2.h5")
