...
save_model_weights_hdf5(model, "datos/word_embedding.h5")
#save_model_weights_hdf5(model, "datos/modelos_finales/word_embedding.h5")
...
model %>%
  load_model_weights_hdf5("datos/word_embedding.h5") %>%
