...
model <- keras_model_sequential() %>%
  ...
  layer_lstm(units = 64) %>% # Funciona mejor la 32 que la 64
  # Quitar dropout
  layer_flatten() %>%
...
#save_model_weights_hdf5(model, "datos/lstm.h5")
save_model_weights_hdf5(model, "datos/modelos_finales/lstm.h5")
...
model %>%
  load_model_weights_hdf5("datos/lstm.h5") %>%
