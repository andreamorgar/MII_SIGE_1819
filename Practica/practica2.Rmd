...
separaCarlos <- function(carpeta_train, carpeta_test, porcentaje = 0.2) {
...
separaCarlos("./petfinder-adoption-prediction/train_images", "./petfinder-adoption-prediction/test_pro")
```
